...
<body>
    ...
    <div class="management">Management</div>
        <ul class="nav">
            ...
            <li><a href="<%=request.getContextPath()%>/admin/user/bookslist" class="current">저서리스트</a></li>
        ...
        <div class="search">
           ...
           <table class="table table-bordered">
	        ...
	        <div class="regi-btn">
				<button class="btn btn-outline-secondary"><a href="<%=request.getContextPath()%>/admin/user/books">저서등록</a></button>
	        </div>
