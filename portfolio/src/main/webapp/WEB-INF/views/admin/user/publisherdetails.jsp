    ...
    <div class="container">
      <h1>PUBLISHER DETAILS</h1>
        <div class="form-group">
            <label>출판사번호</label>
            <input type="text" class="form-control" value="${publisher.pu_num}">
         </div>
         <div class="form-group">
            <label>출판사명</label>
            <input type="text" class="form-control" value="${publisher.pu_name}">
         </div>
         <div class="form-group">
            <label>전화번호</label>
            <input type="text" class="form-control" value="${publisher.pu_phone}">
         </div>
         <div class="form-group">
            <label>대표자명</label>
            <input type="text" class="form-control" value="${publisher.pu_ceo}">
         </div>
