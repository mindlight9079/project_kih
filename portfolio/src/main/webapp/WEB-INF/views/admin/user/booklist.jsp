...
<body>
    ...
    <div class="management">Management</div>
        <ul class="nav">
            ...
            <li><a href="<%=request.getContextPath()%>/admin/user/booklist" class="current">책리스트</a></li>
        ...
        <div class="regi-btn">
			<button class="btn btn-outline-secondary"><a href="<%=request.getContextPath()%>/admin/user/book">도서등록</a></button>
        </div>
