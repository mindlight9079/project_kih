...
public class Lotto {
	...
	public static void main(String[] args) {
		...
		/* 사용자 번호를 랜덤으로 생성하고, 당첨 번호를 입력하면 당첨 등수를 출력하는 코드를 작성하세요.
	...
	public static int init(int arr[], int min, int max) {
		int cnt =0;
	...
	/* 기능    : 자동생성번호와 당첨번호, 보너스번호가 주어지면 몇 등인지 알려주는 메소드
				단, 꽝은 0등으로 표현
	 * 매개변수 : 자동생성번호, 당첨번호, 보너스 번호 => int []user, int []lotto, int bonus
	 * 리턴타입 : 당첨 등수 => 정수 => int 
	 * 메소드명 : rank
	 */
...
//			res = contains(user,user.length,bonus)? 2:3;
	...
	/* 기능    : 자동생성 번호와 로또번호, 보너스가 주어지면 당첨 등수를 출력하는 메소드
	 * 매개변수 : 자동생성 번호, 당첨번호, 보너스 => int []user, int []lotto, int bonus
	 * 리턴타입 : 없음 => void
	 * 메소드명 : printRank
	 */
