...
//		System.out.println(str.substring(2,3));
		...
		System.out.println("주민번호를 입력하세요(예:020101-3234567) : ");
...
//		if(str2 == null && str2.subSequence(7, 8).equals("3")) {
//		System.out.println("20"+str2.substring(0, 2)+"년"+str2.substring(2, 4)+"월"+str2.substring(4, 6)+"일");
//		} else {
//			System.out.println("19"+str2.substring(0, 2)+"년"+str2.substring(2, 4)+"월"+str2.substring(4, 6)+"일");
//		}
//			scan.close();
