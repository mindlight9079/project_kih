...
create table if not exists singer(
    ...
    si_start_year int not null,
    si_agency varchar(30) not null,
    primary key(si_num),
...
create table if not exists artist (
	ar_num int auto_increment primary key,
...
create table if not exists `member` (
	me_num int auto_increment primary key,
...
- 음포가번호 : sn_num int auto increment 기본키
