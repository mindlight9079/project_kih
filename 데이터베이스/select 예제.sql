...
-- select 등급 from 고객;
-- select문에서 테이블명 앞에 데이터베이스명을 안쓰면 현재 선택된 데이터베이스에 따라 쿼리문이 실행되지 않을수도 있다.
...
-- select avg(수량) as 'apple의 평균 주문양' from 주문 where 주문고객 = 'apple';
