...
insert into student(st_id, st_num, st_res_num, st_pw, st_dep, st_name)studentstudentstudent
values ('abc124', '2020160002', '010528-3456789', 'abc123', '컴공', '가다');
-- 테이블명 옆에 속성을 생략한 경우, 학번, 아이디, 주민번호, 비번, 이름, 학과순으로 추가해야한다.
desc student;
insert into student
values('202016003', 'abc', '010527-4567890', 'abc', '나다', '컴공');

-- 여러 행을 추가하는 경우
insert into student
values('2020160005', 'abc789', '010527-4567891', 'abc789', '라마가', '컴공'),
('2020160009', 'qwe789', '010527-4567892', 'abc789', '박씨', '컴공');
select * from student;